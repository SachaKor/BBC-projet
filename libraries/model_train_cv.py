...
class ModelTrain(object):
	...
	#####
        for f in array_list_files_name:
            if(f.startswith(".")):
                array_list_files_name.remove(f)
    ...
    def saveResultsIntoCSVFile(self, path_to_save:str, path_directory_models:str):
        ...
        array_list_files_name = self.array_list_files_name
        ...
        print(results_scores_array.shape)
        print(array_list_files_re.shape)
        print(results_scores_array)
        print(array_list_files_re)
